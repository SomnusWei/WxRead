# 📦 WxReadAssistant v2.2.2 — Release Note
> 打包日期：2026-08-26  ·  构建 SHA：2c05b95f

## 下载地址

| 文件 | 说明 |
|------|------|
| `WxReadAssistant-v2.2.2-full.zip` | 完整安装包（**首次安装** 或 **从任意旧版本升级** 解压即用） |
...
> 完整 sha1 清单见 `WxReadAssistant-v2.2.2`-full.sha1.txt
